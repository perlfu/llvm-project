...
class AMDGPUMarkSGPRHazardRegs : public MachineFunctionPass {
public:
  static char ID;

  AMDGPUMarkSGPRHazardRegs() : MachineFunctionPass(ID) {}
...
INITIALIZE_PASS(AMDGPUMarkSGPRHazardRegs, DEBUG_TYPE,
                "AMDGPU Mark Hazard SGPRs", false, false)

char AMDGPUMarkSGPRHazardRegs::ID = 0;

char &llvm::AMDGPUMarkSGPRHazardRegsID = AMDGPUMarkSGPRHazardRegs::ID;

bool AMDGPUMarkSGPRHazardRegs::runOnMachineFunction(MachineFunction &MF) {
