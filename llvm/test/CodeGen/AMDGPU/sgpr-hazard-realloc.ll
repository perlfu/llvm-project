...
; DEF-NEXT:    s_xor_b32 s1, vcc_lo, exec_lo
; DEF-NEXT:    s_wait_alu 0xfffe
...
; V1-NEXT:    s_xor_b32 s1, vcc_lo, exec_lo
...
; V2-NEXT:    s_xor_b32 vcc_lo, vcc_lo, exec_lo
...
; V3-NEXT:    s_sub_f32 s81, s0, s1
; V3-NEXT:    s_delay_alu instid0(SALU_CYCLE_3) | instskip(NEXT) | instid1(VALU_DEP_1)
; V3-NEXT:    v_dual_add_f32 v0, s104, v0 :: v_dual_add_f32 v1, s81, v1
; V3-NEXT:    v_readfirstlane_b32 s0, v0
; V3-NEXT:    s_delay_alu instid0(VALU_DEP_2) | instskip(SKIP_1) | instid1(VALU_DEP_2)
...
; V3-NEXT:    s_and_b32 s104, s104, s81
; V3-NEXT:    s_buffer_load_b32 s1, s[0:3], 0x0
; V3-NEXT:    v_add_f32_e32 v0, v0, v1
; V3-NEXT:    s_wait_kmcnt 0x0
; V3-NEXT:    s_lshl_b32 s81, s1, s104
; V3-NEXT:    s_wait_alu 0xfffe
; V3-NEXT:    v_cmp_ne_u32_e32 vcc_lo, s81, v1
; V3-NEXT:    s_xor_b32 s1, vcc_lo, exec_lo
